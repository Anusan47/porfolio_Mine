...
export const data = {
  ...
  obsessionsRow1: [
    { src: "/sunsets/ducati.jpg", alt: "Ducati" },
    { src: "/sunsets/porsche.jpg", alt: "Porsche" },
    { src: "/sunsets/Annapurana.jpg", alt: "Annapurna Mountain" },
    { src: "/sunsets/cat1.jpg", alt: "Cat" },
    { src: "/sunsets/amadablam.jpg", alt: "Ama Dablam Mountain" },
    { src: "/sunsets/defender.jpg", alt: "Defender" },
  ],
  obsessionsRow2: [
    { src: "/sunsets/s1000rr.jpg", alt: "BMW S1000RR" },
    { src: "/sunsets/rangerover.jpg", alt: "Range Rover" },
    { src: "/sunsets/Everest.jpg", alt: "Mount Everest" },
    { src: "/sunsets/cat2.jpg", alt: "Cat" },
    { src: "/sunsets/amadablam2.jpg", alt: "Ama Dablam Mountain" },
    { src: "/sunsets/ducati2.jpg", alt: "Ducati" },
  ]
};